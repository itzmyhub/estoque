package nk.estoque.infraestructure.web.funcionario;

import jakarta.validation.Valid;
import nk.estoque.infraestructure.entity.funcionario.FuncionarioEntity;
import nk.estoque.application.funcionario.dto.FuncionarioDTO;
...
public class FuncionarioController {
    ...
    @PostMapping
    public ResponseEntity<FuncionarioEntity> post(@Valid @RequestBody FuncionarioDTO funcionarioDTO) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<FuncionarioEntity> put(@PathVariable Long id, @Valid @RequestBody FuncionarioDTO funcionarioDTO) {
        Funcionario funcionario = funcionarioDTO.toFuncionario();
